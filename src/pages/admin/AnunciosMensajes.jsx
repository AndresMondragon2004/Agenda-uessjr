    ...
    <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
      <div className="bg-white dark:bg-[#122A1C] rounded-2xl shadow-2xl p-8 max-w-md w-full text-center anim-scale-in border border-emerald-900/20">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-sm mb-4 leading-relaxed">
          ...
          {programa !== 'todos' && (
            <> del programa <strong className="text-[#0F5B3C] dark:text-emerald-400">{PROGRAMA_LABELS[programa]}</strong></>
          )}.
        </p>
        ...
        <div className="space-y-3">
          <button
            onClick={onConfirm}
            disabled={loading}
            className="w-full py-4 bg-[#0F5B3C] text-white font-black rounded-2xl hover:bg-emerald-800 transition-all disabled:opacity-50 flex items-center justify-center gap-2 text-xs uppercase tracking-[0.2em] shadow-lg shadow-emerald-900/20"
          >
            {loading
      ...
      <div className="max-w-5xl mx-auto px-4 mt-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 space-y-6">
                  ...
                  return (
                    <button
                      ...
                      className={`p-4 rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all border text-left flex flex-col justify-between h-24
                        ${active 
                          ? 'bg-[#0F5B3C] text-white border-[#0F5B3C] shadow-xl shadow-emerald-900/20 translate-y-[-2px]' 
            ...
            <div className="bg-white dark:bg-[#122A1C] rounded-[2.5rem] p-8 shadow-sm border border-gray-100 dark:border-emerald-900/30">
              ...
              <textarea
                ...
                className="w-full p-6 bg-gray-50 dark:bg-[#0F2018] border border-gray-100 dark:border-emerald-900/50 rounded-[2rem] outline-none focus:border-[#0F5B3C] text-base font-medium dark:text-gray-200 resize-none transition-all placeholder:text-gray-400"
              />
              ...
              {sending ? (
                <div className="space-y-4">
                  <div className="h-4 bg-gray-100 dark:bg-emerald-900/20 rounded-full overflow-hidden shadow-inner">
                    <div className="h-full bg-gradient-to-r from-[#0F5B3C] to-emerald-500 transition-all duration-300" style={{ width: `${pct}%` }} />
                  </div>
                ...
                <button
                  ...
                  className="w-full py-5 rounded-[1.5rem] font-black text-xs uppercase tracking-[0.3em] transition-all flex items-center justify-center gap-4 bg-[#0F5B3C] text-white shadow-xl shadow-emerald-900/30 hover:bg-emerald-800 disabled:opacity-40 active:scale-[0.98]"
                >
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            {/* Info Card */}
            <div className="bg-gradient-to-br from-[#0F5B3C] to-[#0B1310] rounded-[2.5rem] p-8 text-white relative overflow-hidden shadow-xl">
