    ...
    <>
      ...
      <div className="bg-white dark:bg-[#122A1C] border-b border-gray-100 dark:border-emerald-900/40 px-4 sm:px-8 py-4 flex items-center justify-between sticky top-14 lg:top-0 z-10">
        <button
          ...
          className="text-gray-500 dark:text-gray-400 hover:text-[#0F5B3C] dark:hover:text-emerald-400 font-semibold text-sm flex items-center gap-1.5 transition-colors"
        >
        ...
        <div className="flex gap-2 sm:gap-3">
          <button
            ...
            style={{ background: 'linear-gradient(135deg, #0F5B3C, #2D6A4F)' }}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        <div className="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-4 bg-emerald-50 dark:bg-emerald-900/20 px-6 py-4 rounded-3xl border border-emerald-100 dark:border-emerald-900/40 flex-1">
            <div className="w-10 h-10 rounded-2xl bg-[#0F5B3C] text-white flex items-center justify-center shadow-lg">
              <UserCheck size={20} />
            </div>
            <div>
          ...
          <button
            ...
            className="px-6 py-4 bg-white dark:bg-[#122A1C] border border-gray-100 dark:border-emerald-900/40 text-[#0F5B3C] dark:text-emerald-400 font-black text-[11px] uppercase tracking-widest rounded-3xl hover:bg-emerald-50 dark:hover:bg-emerald-900/20 transition-all flex items-center justify-center gap-2 shadow-sm disabled:opacity-50"
          >
            {exporting ? (
        ...
        {loading ? (
          <div className="flex items-center justify-center py-24">
            <div className="text-center">
              <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#0F5B3C] mx-auto mb-4" />
          ...
          <div className="text-center py-24 bg-white rounded-2xl border border-gray-100 shadow-sm">
            ...
            <button type="button" onClick={() => navigate('/admin/sesiones')}
                    className="px-6 py-2.5 bg-[#0F5B3C] text-white font-semibold rounded-xl">
              Volver al listado
            </button>
          </div>
        ) : (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="bg-white dark:bg-[#122A1C] rounded-2xl shadow-sm border border-gray-100 dark:border-emerald-900/40 overflow-hidden">
                {/* Header visual */}
                <div className="h-32 sm:h-40 bg-gradient-to-r from-[#0F5B3C] to-[#2D6A4F] relative p-8">
                  ...
                  <div className="flex flex-col sm:flex-row items-center sm:items-start gap-8">
                    {sesion.ponente_foto_url ? (
                      ...
                      <div className="w-24 h-24 rounded-2xl bg-gradient-to-br from-emerald-50 to-emerald-100 dark:from-emerald-900/40 dark:to-emerald-900/60 flex items-center justify-center shrink-0 border-4 border-white dark:border-emerald-900/40 shadow-sm">
                        <span className="text-[#0F5B3C] dark:text-emerald-400 text-3xl font-black">
                  ...
                  <div className="relative">
                    <svg className="w-32 h-32 transform -rotate-90">
                      ...
                      <circle cx="64" cy="64" r="58" stroke="currentColor" strokeWidth="8" fill="transparent"
                              ...
                              className={`${pctOcupacion >= 100 ? 'text-red-500' : pctOcupacion >= 80 ? 'text-amber-500' : 'text-[#0F5B3C]'} transition-all duration-1000`} />
                    </svg>
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="flex gap-2">
                      ...
                      <button 
                        ...
                        className="px-3 py-2 bg-[#0F5B3C] hover:bg-emerald-800 text-white rounded-xl transition-colors shrink-0"
