  ...
  return (
    <div className="min-h-screen bg-[#F2F5F3] dark:bg-[#0A1A11] pb-20">
      ...
      <div className="bg-white dark:bg-[#122A1C] border-b border-gray-100 dark:border-emerald-900/40 px-4 sm:px-8 py-6 sticky top-0 z-20">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 bg-emerald-100 dark:bg-emerald-900/40 rounded-2xl flex items-center justify-center text-[#22573E] dark:text-emerald-400 shadow-inner">
              <Brain size={24} />
            </div>
            <div>
          ...
          <button 
            ...
            className="bg-[#22573E] text-white px-6 py-3 rounded-xl font-black text-xs uppercase tracking-widest hover:bg-emerald-800 transition-all shadow-lg flex items-center justify-center gap-2"
          >
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-8 mt-8">
        ...
        {/* Intro Card */}
        <div className="bg-gradient-to-br from-[#22573E] to-[#0D2B1D] rounded-[2.5rem] p-8 text-white mb-8 relative overflow-hidden shadow-xl shadow-emerald-950/20">
        ...
        <div className="relative mb-6">
          ...
          <input 
            ...
            className="w-full pl-12 pr-4 py-4 bg-white dark:bg-[#122A1C] border border-gray-100 dark:border-emerald-900/30 rounded-2xl outline-none focus:border-[#22573E] font-bold text-sm shadow-sm"
          />
        </div>
            ...
            filtered.map(item => (
              <div key={item.id} className="group bg-white dark:bg-[#122A1C] p-6 rounded-3xl border border-gray-100 dark:border-emerald-900/30 hover:shadow-xl transition-all relative">
                <div className="flex justify-between items-start mb-4">
                  <span className="px-3 py-1 bg-emerald-50 dark:bg-emerald-900/40 text-[#22573E] dark:text-emerald-400 rounded-lg text-[9px] font-black uppercase tracking-widest border border-emerald-100 dark:border-emerald-800/30">
                    {item.categoria}
                  </span>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-emerald-950/40 backdrop-blur-md animate-in fade-in duration-200">
          <form onSubmit={handleSave} className="bg-white dark:bg-[#122A1C] w-full max-w-xl rounded-[2.5rem] shadow-2xl border border-emerald-100 dark:border-emerald-900/40 overflow-hidden anim-scale-in">
            <div className="p-8 border-b border-gray-50 dark:border-emerald-900/30 flex items-center justify-between">
              <div>
                <h3 className="font-black text-xl text-[#22573E] dark:text-emerald-400 uppercase tracking-tight">
            ...
            <div className="p-8 space-y-6">
              <div>
                ...
                <input 
                  ...
                  className="w-full p-4 bg-gray-50 dark:bg-[#0F2018] border border-gray-100 dark:border-emerald-900/50 rounded-2xl outline-none focus:border-[#22573E] text-sm font-bold dark:text-gray-100"
                />
              </div>
              ...
              <div>
                ...
                <textarea 
                  ...
                  className="w-full p-4 bg-gray-50 dark:bg-[#0F2018] border border-gray-100 dark:border-emerald-900/50 rounded-2xl outline-none focus:border-[#22573E] text-sm font-medium dark:text-gray-200 h-32 resize-none"
                />
              </div>
              ...
              <div>
                ...
                <select 
                  ...
                  className="w-full p-4 bg-gray-50 dark:bg-[#0F2018] border border-gray-100 dark:border-emerald-900/50 rounded-2xl outline-none focus:border-[#22573E] text-xs font-black uppercase tracking-widest dark:text-gray-100"
                >
            ...
            <div className="p-8 bg-gray-50 dark:bg-emerald-900/20 flex gap-3">
              ...
              <button 
                ...
                className="flex-2 py-4 bg-[#22573E] text-white rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-emerald-800 transition-all shadow-lg flex items-center justify-center gap-2"
              >
