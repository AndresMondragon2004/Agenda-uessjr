    ...
    <div className={`bg-white dark:bg-[#122A1C] rounded-3xl p-6 border shadow-sm
      ...
      <div className="flex flex-col md:flex-row md:items-center gap-6">
        ...
        <div className="md:w-32 flex md:flex-col items-center md:items-start gap-2
          ...
          <span className="px-3 py-1.5 bg-emerald-50 dark:bg-emerald-900/30 text-[#163020] dark:text-emerald-400 rounded-xl
        ...
        <div className="flex-1 min-w-0">
          ...
          <h3 className="text-lg font-black text-gray-900 dark:text-gray-100 group-hover:text-[#163020] dark:group-hover:text-emerald-400
        ...
        <div className="flex items-center gap-2 md:opacity-0 group-hover:opacity-100
          ...
          <button onClick={() => navigate('/admin/sesiones/' + ses.id)}
                  className="p-2.5 text-gray-400 border border-gray-100 dark:border-emerald-900/40 rounded-xl
                             hover:text-[#163020] hover:bg-emerald-50 dark:hover:bg-emerald-900/20 hover:border-emerald-100 dark:hover:border-emerald-800
...
function DaySeparator({ fecha, nombreDia, count }) {
  ...
  return (
    <div className="flex items-center gap-4 mb-4 mt-6 first:mt-0">
      <div className="flex items-center gap-2 bg-[#163020]/8 dark:bg-emerald-900/30 px-4 py-2 rounded-xl">
        <CalendarDays className="w-3.5 h-3.5 text-[#163020] dark:text-emerald-400" />
        ...
        <span className="text-[9px] font-bold text-[#163020]/50">
...
export default function SessionsManagement() {
  ...
  const handleAsignarDia = async (sesionId, diaJornadaId) => {
    try {
      ...
      cargarDatos()
      toast.success('Día asignado correctamente')
    } catch (err) {
      setError(err.message)
    }
  }
    ...
    <>
      ...
      <div className="bg-white dark:bg-[#122A1C] border-b border-gray-100 dark:border-emerald-900/40 px-4 sm:px-8 py-4
        ...
        <button
          ...
          className="flex items-center gap-2 px-5 py-2.5 bg-[#163020] text-white
            ...
            <div className="bg-white dark:bg-[#122A1C] rounded-3xl p-6 shadow-sm border border-gray-100 dark:border-emerald-900/40 mb-8 space-y-5">
              ...
              <div className="flex flex-col md:flex-row gap-4">
                <div className="relative flex-1 group">
                  <Search className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400 group-focus-within:text-[#163020] transition-colors" />
                  <input
                    type="text"
                    ...
                    className="w-full pl-11 pr-4 py-3.5 rounded-2xl border border-gray-100 dark:border-emerald-900/50
                               bg-gray-50/50 dark:bg-[#0F2018] focus:bg-white dark:focus:bg-[#0F2018] focus:border-[#163020]
                ...
                <select
                  ...
                  className="px-4 py-3.5 rounded-2xl border border-gray-100 dark:border-emerald-900/50 bg-gray-50/50 dark:bg-[#0F2018]
                             focus:bg-white dark:focus:bg-[#0F2018] focus:border-[#163020] outline-none text-[10px] font-black uppercase
                ...
                <button
                  ...
                  className={`px-5 py-2.5 rounded-xl text-[10px] font-black uppercase
                              ...
                              ${diaFiltro === 'todos'
                                ...
                                : 'bg-white dark:bg-[#0F2018] text-gray-400 dark:text-gray-500 border-gray-100 dark:border-emerald-900/30 hover:border-[#163020] dark:hover:border-emerald-700'}`}
                >
                  Ver todos los días
                </button>
                {dias.map(dia => {
