      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:border-[#0F5B3C] outline-none text-base min-h-[44px]"
              />
            </div>
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:border-[#0F5B3C] outline-none pr-12 text-base min-h-[44px]"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-[#0F5B3C] text-white font-bold rounded-lg hover:bg-emerald-800 transition-colors disabled:opacity-50"
            >
          ...
          <div className="mt-6 pt-4 border-t border-gray-100 text-center">
            <Link to="/login" className="text-sm text-gray-400 hover:text-[#0F5B3C] transition-colors">
