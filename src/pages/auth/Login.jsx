    ...
    <AuthLayout>
      ...
      <div className="flex justify-between items-start mb-8">
        ...
        <button
          onClick={toggleDark}
          type="button"
          className="p-3 rounded-2xl bg-gray-50 dark:bg-[#0F2018] border border-gray-100 dark:border-emerald-900/50 text-gray-400 dark:text-gray-500 hover:text-[#0F5B3C] dark:hover:text-emerald-400 transition-all shadow-sm"
          title="Cambiar tema"
        >
