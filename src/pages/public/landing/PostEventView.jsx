    ...
    <div className="min-h-screen bg-[#F5F4F0] dark:bg-[#05140B]">
      ...
      <section className="relative pt-32 pb-20 bg-[#05140B] overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl sm:text-6xl font-black text-white mb-6 tracking-tight anim-reveal anim-stagger-2">
            ¡Misión <span className="text-amber-300">cumplida!</span>
          </h1>
          <p className="text-white/70 text-xl max-w-2xl mx-auto mb-10 anim-reveal anim-stagger-3">
          ...
          <div className="flex justify-center gap-4 anim-reveal anim-stagger-4">
      ...
      <section className="max-w-7xl mx-auto px-4 -mt-10 relative z-20" ref={statsRef}>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <div 
              key={i} 
              className={`bg-white dark:bg-[#122A1C] p-8 rounded-[2rem] shadow-xl border border-gray-100 dark:border-emerald-900/30 flex items-center gap-6 ${statsVis ? 'anim-reveal' : 'opacity-0'}`} 
      ...
      {isLoggedIn && estudiante && (
        <section className="max-w-4xl mx-auto px-4 py-16" ref={certRef}>
          <div className={`bg-white dark:bg-[#122A1C] rounded-[3rem] p-8 sm:p-12 border border-gray-100 dark:border-emerald-900/30 shadow-2xl relative overflow-hidden ${certVis ? 'anim-reveal' : 'opacity-0'}`}>
      ...
      <section className="bg-white dark:bg-[#0B1A12] py-20" ref={cierreRef}>
        <div className={`max-w-4xl mx-auto px-4 text-center ${cierreVis ? 'anim-fade-up' : 'opacity-0'}`}>
          ...
          <div className="flex flex-wrap justify-center gap-6 grayscale opacity-50">
            <img src="https://ydcybysimlvatvadpbaz.supabase.co/storage/v1/object/public/images/umb.png" className="h-10 dark:brightness-0 dark:invert" alt="UMB" />
            <img src="/images/logos/ues-sjr.png" className="h-10 dark:brightness-0 dark:invert" alt="UES SJR" />
          </div>
        </div>
      </section>
