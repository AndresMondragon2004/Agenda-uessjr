...
export default function VerifyCertificate() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFB] dark:bg-[#0B1310] flex items-center justify-center p-4 sm:p-8">
        ...
        <div className="p-8 sm:p-12">
          ...
          {loading ? (
            <div className="py-20 text-center">
              <Loader2 className="w-12 h-12 animate-spin text-[#0F5B3C] mx-auto mb-4" />
            ...
            <div className="text-center py-12">
              ...
              <Link to="/" className="inline-flex items-center gap-2 text-[#0F5B3C] dark:text-emerald-400 font-bold hover:underline">
            ...
            <div className="anim-fade-up">
              ...
              <div className="mt-10 text-center">
                ...
                <div className="mt-8">
                   <Link to="/" className="bg-[#0F5B3C] text-white px-8 py-3 rounded-xl font-bold text-xs uppercase tracking-widest hover:bg-emerald-800 transition-all shadow-lg shadow-emerald-900/20">
                    Portal de Jornada
                   </Link>
                </div>
              </div>
