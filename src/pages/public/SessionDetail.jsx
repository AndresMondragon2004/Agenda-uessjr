  ...
  if (loading) return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-[#0A1A11]">
      <div className="flex flex-col items-center gap-4">
        <div className="w-12 h-12 rounded-full border-4 border-[#22573E]/20 dark:border-emerald-900/50 border-t-[#22573E] dark:border-t-emerald-500 animate-spin" />
  ...
  if (error || !sesion) return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-[#0A1A11] px-4">
      <div className="text-center py-16 max-w-sm">
        ...
        <Link to="/agenda" className="px-6 py-2.5 bg-[#22573E] text-white font-semibold rounded-xl hover:bg-emerald-800 transition-colors">
          Ver agenda
        </Link>
      </div>
    </div>
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-[#0A1A11] pb-12">
      ...
      <div className="relative pt-32 lg:pt-36 pb-20 overflow-hidden">
        ...
        {(sesion.dias_jornada?.imagen_url || IMAGENES_POR_DIA[sesion.dias_jornada?.nombre_dia]) ? (
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-[#0D2B1D] to-[#22573E]" />
        )}
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-5 order-2 lg:order-1">
              ...
              <div className="bg-white dark:bg-[#122A1C] rounded-2xl shadow-sm border border-gray-100 dark:border-emerald-900/40 p-6">
                ...
                <div className="flex items-start gap-5">
                  {sesion.ponente_foto_url ? (
                    ...
                    <div className="w-16 h-16 rounded-full bg-gradient-to-br from-[#22573E] to-emerald-600 flex items-center justify-center shrink-0">
                  ...
                  <div>
                    <p className="font-bold text-gray-900 dark:text-gray-100 text-lg leading-tight">
                      {sesion.ponente_grado && (
                        <span className="text-[#22573E] dark:text-emerald-400">{sesion.ponente_grado} </span>
                      )}
                      {sesion.ponente_nombre}
                    </p>
            ...
            {sesion.descripcion && (
              <div className="bg-white dark:bg-[#122A1C] rounded-2xl shadow-sm border border-gray-100 dark:border-emerald-900/40 p-6">
                <h2 className="font-bold text-gray-900 dark:text-gray-100 text-lg border-l-4 border-[#22573E] dark:border-emerald-600 pl-3 mb-4">
            ...
            {/* Detalles */}
            <div className="bg-white dark:bg-[#122A1C] rounded-2xl shadow-sm border border-gray-100 dark:border-emerald-900/40 p-6">
              <h2 className="font-bold text-gray-900 dark:text-gray-100 text-base mb-4 border-l-4 border-[#22573E] dark:border-emerald-600 pl-3">
                Detalles de la sesión
              </h2>
              <dl className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {fechaFormateada && (
                  <div className="flex items-start gap-3">
                    <CalendarDays size={16} className="text-[#22573E] dark:text-emerald-500 shrink-0 mt-0.5" />
                    <div>
                ...
                {sesion.hora_inicio && (
                  <div className="flex items-start gap-3">
                    <Clock size={16} className="text-[#22573E] dark:text-emerald-500 shrink-0 mt-0.5" />
                    <div>
                ...
                {sesion.escenarios?.nombre && (
                  <div className="flex items-start gap-3">
                    <MapPin size={16} className="text-[#22573E] dark:text-emerald-500 shrink-0 mt-0.5" />
                    <div>
                ...
                {(sesion.programa_academico || []).length > 0 && (
                  <div className="flex items-start gap-3">
                    <Users size={16} className="text-[#22573E] dark:text-emerald-500 shrink-0 mt-0.5" />
                    <div>
            ...
            {yaInscrito && (
              <div className="bg-white dark:bg-[#122A1C] rounded-2xl shadow-sm border border-gray-100 dark:border-emerald-900/40 p-6 mt-8">
                <h2 className="font-bold text-gray-900 dark:text-gray-100 text-lg border-l-4 border-[#22573E] dark:border-emerald-600 pl-3 mb-4 flex items-center gap-2">
                ...
                <div className="mb-6 flex gap-3">
                  <input
                    ...
                    className="flex-1 px-4 py-3 bg-gray-50 dark:bg-[#0F2018] rounded-xl outline-none focus:border-[#22573E] text-sm text-gray-900 dark:text-gray-100 border border-gray-200 dark:border-emerald-900/50"
                  />
                  <button
                    onClick={handleEnviarPregunta}
                    disabled={enviandoPregunta || !nuevaPregunta.trim()}
                    className="px-4 py-3 bg-[#22573E] text-white rounded-xl hover:bg-emerald-800 transition-colors disabled:opacity-50 shrink-0 flex items-center gap-2"
                  >
                  ...
                  <div className="bg-gray-100 dark:bg-emerald-950/50 rounded-full h-2.5 overflow-hidden">
                    <div
                      className={`rounded-full h-2.5 transition-all ${
                        lleno ? 'bg-red-500' : pct >= 80 ? 'bg-amber-500' : 'bg-[#22573E]'
                      }`}
                      style={{ width: `${pct}%` }}
                    />
                  </div>
              ...
              {finalizada ? (
                ...
                <button
                  ...
                  className={`w-full py-3.5 text-white font-bold rounded-xl transition-all mb-3 disabled:opacity-50 text-sm ${
                    lleno ? 'bg-amber-600 hover:bg-amber-700' : 'bg-[#22573E] hover:bg-emerald-800'
                  }`}
                >
                  {inscribiendo
                    ? 'Procesando...'
              ...
              {!finalizada && sesion.dias_jornada?.fecha && sesion.hora_inicio && (
                <div className="space-y-2 mb-3">
                  <a
                    ...
                    className="flex items-center justify-center gap-2 w-full py-2.5 border-2 border-[#22573E] dark:border-emerald-700 text-[#22573E] dark:text-emerald-400 font-semibold rounded-xl hover:bg-emerald-50 dark:hover:bg-emerald-900/20 transition-all text-sm"
                  >
            ...
            {yaAsistio && (
              <div className="mt-6 bg-white dark:bg-[#122A1C] rounded-2xl p-8 shadow-md border border-gray-100 dark:border-emerald-900/40 text-center anim-fade-up">
                ...
                <button 
                  ...
                  className="w-full py-4 bg-[#22573E] text-white font-black uppercase text-xs tracking-widest rounded-2xl hover:bg-emerald-800 transition-all shadow-lg shadow-emerald-900/20"
                >
          ...
          <div className="bg-white dark:bg-[#122A1C] rounded-[2.5rem] p-8 sm:p-12 shadow-2xl border border-gray-100 dark:border-emerald-900/30 w-full max-w-xl relative anim-fade-up">
            ...
            {yaValoro ? (
              <div className="p-6 bg-emerald-50 dark:bg-emerald-950/40 rounded-3xl border border-emerald-100 dark:border-emerald-900/30 text-center sm:text-left">
                ...
                <p className="text-[#22573E] dark:text-emerald-400 font-bold">¡Valoración enviada!</p>
              ...
              <div className="space-y-6">
                ...
                <div>
                  <textarea 
                    ...
                    className="w-full p-5 bg-gray-50 dark:bg-[#0F2018] border border-gray-100 dark:border-emerald-900/50 rounded-[2rem] outline-none focus:border-[#22573E] text-sm font-medium dark:text-gray-200 resize-none h-32"
                  />
                </div>
                ...
                <button 
                  ...
                  className="px-10 py-4 w-full bg-[#22573E] text-white font-black uppercase text-xs tracking-widest rounded-2xl hover:bg-emerald-800 transition-all shadow-lg shadow-emerald-900/20 disabled:opacity-50"
                >
      ...
      {toast && (
        <div className={`fixed bottom-6 left-4 right-4 sm:left-auto sm:right-6 z-50 px-6 py-3.5 rounded-2xl shadow-xl text-sm font-semibold flex items-center gap-2 anim-fade-up ${
          toast.type === 'error' ? 'bg-red-600 text-white' : 'bg-[#22573E] text-white'
        }`}>
