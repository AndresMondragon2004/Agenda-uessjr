    ...
    <div className="min-h-screen bg-gray-50 dark:bg-[#0A1A11]">
      ...
      <div className="bg-white dark:bg-[#122A1C] border-b border-gray-100 dark:border-emerald-900/40 px-4 sm:px-8 pt-28 pb-10">
        <div className="max-w-5xl mx-auto">
          <h1 className="text-3xl font-extrabold text-[#22573E] dark:text-emerald-400">Mi agenda</h1>
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            {!finalizada && (
              <Link
                ...
                className="flex-1 sm:flex-none px-6 py-3 bg-[#22573E] text-white text-[10px] font-black uppercase tracking-[0.2em] rounded-xl hover:bg-emerald-800 transition-all shadow-lg shadow-emerald-950/20 flex items-center justify-center gap-2 transform hover:-translate-y-0.5 active:scale-95"
              >
            ...
            {inscripciones.length > 0 && (
              <button
                ...
                disabled={generating}
                className="flex-1 sm:flex-none px-6 py-3 bg-white dark:bg-[#0F2018] text-[#22573E] dark:text-emerald-400 border-2 border-[#22573E] dark:border-emerald-900/50 text-[10px] font-black uppercase tracking-[0.2em] rounded-xl hover:bg-gray-50 dark:hover:bg-emerald-900/20 transition-all shadow-sm flex items-center justify-center gap-2"
              >
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs font-medium text-gray-600 dark:text-gray-400 leading-tight">
                    ...
                    <Link to={`/ticket/${estudiante.id}`} className="ml-1 text-[#22573E] dark:text-emerald-400 font-bold hover:underline">O ver ticket en la web →</Link>
                  </p>
                </div>
              </div>
              <a
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-10">
              ...
              <div className="lg:col-span-2 bg-[#22573E] rounded-[2.5rem] p-8 text-white relative overflow-hidden shadow-xl shadow-emerald-950/20">
              ...
              <div className="bg-white dark:bg-[#122A1C] rounded-[2.5rem] p-8 border border-gray-100 dark:border-emerald-900/30 shadow-sm flex flex-col justify-center text-center">
                <div className="w-14 h-14 bg-emerald-50 dark:bg-emerald-950/40 rounded-2xl flex items-center justify-center mx-auto mb-4">
                  <Users className="text-[#22573E] dark:text-emerald-400" size={24} />
                </div>
                    ...
                    <div className="space-y-3">
                      {inscs
                        ...
                        .map(insc => {
                          ...
                          return (
                            <div key={insc.id}
                                 className="bg-white dark:bg-[#122A1C] rounded-2xl shadow-sm border-l-4 border-[#22573E] dark:border-emerald-600
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 sm:gap-6">
                              ...
                              <div className="shrink-0 flex flex-col gap-2 sm:min-w-[140px] pt-2 sm:pt-0">
                                <Link
                                  to={`/agenda/${ses.id}`}
                                  className="w-full flex items-center justify-center px-4 py-2.5 bg-[#22573E] text-white text-xs font-bold
