          ...
          {activeTab === 'overview' && (
            <div className="space-y-10 anim-fade-up">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-[#1B4332] dark:bg-emerald-900 p-8 rounded-[2.5rem] shadow-xl relative overflow-hidden group flex flex-col justify-center items-center text-center">
                  ...
                  <button onClick={() => setPresentationMode(true)} className="relative z-10 w-full py-4 bg-white text-[#1B4332] hover:bg-emerald-50 rounded-[1.5rem] font-black uppercase text-xs tracking-widest shadow-2xl transition-all active:scale-95">Modo Escenario</button>
          ...
          {activeTab === 'polls' && (
            <div className="max-w-3xl mx-auto anim-fade-up">
              <div className="flex justify-between items-center mb-8">
                ...
                <button onClick={() => setShowPollModal(true)} className="flex items-center gap-2 px-6 py-3 bg-[#1B4332] text-white rounded-2xl font-black text-xs uppercase tracking-widest shadow-xl active:scale-95"><Plus size={16} /> Crear Encuesta</button>
              </div>
            ...
            <div className="max-w-4xl mx-auto anim-fade-up">
              <div className="bg-white dark:bg-[#122A1C] rounded-[3rem] p-10 shadow-2xl border border-white dark:border-emerald-900/20">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
                  ...
                  <button onClick={downloadCSV} disabled={networkingLeads.length === 0} className="flex items-center gap-2 px-6 py-3 bg-[#1B4332] text-white rounded-2xl font-black text-xs uppercase tracking-widest shadow-xl disabled:opacity-50 active:scale-95"><Download size={16} /> Exportar CSV</button>
                </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <input 
                  ...
                  className="w-full px-5 py-4 bg-gray-50 dark:bg-[#0F2018] border border-gray-100 dark:border-emerald-900/50 rounded-2xl outline-none focus:border-[#1B4332] text-sm font-bold text-gray-900 dark:text-gray-100"
                />
              </div>
              ...
              <div>
                  ...
                  {pollOptions.map((opt, i) => (
                    <div key={i} className="flex gap-2">
                      <input 
                        ...
                        className="flex-1 px-4 py-3 bg-gray-50 dark:bg-[#0F2018] border border-gray-100 dark:border-emerald-900/50 rounded-xl outline-none focus:border-[#1B4332] text-sm font-semibold text-gray-900 dark:text-gray-100"
                      />
                ...
                {pollOptions.length < 5 && (
                  <button 
                    ...
                    className="mt-4 text-xs font-bold text-[#1B4332] dark:text-emerald-400 uppercase tracking-widest flex items-center gap-1 hover:opacity-70 transition-opacity"
                  >
              ...
              <button 
                ...
                className="w-full py-4 mt-4 bg-[#1B4332] text-white font-black uppercase text-xs tracking-widest rounded-2xl hover:bg-emerald-800 transition-all shadow-lg shadow-emerald-900/20 disabled:opacity-50"
              >
