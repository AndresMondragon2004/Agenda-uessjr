              ...
              return (
                <button
                  ...
                  className={`w-full text-left px-3 py-2 rounded-xl text-sm transition-all flex items-center gap-3 group relative
                    ${isActive
                      ? 'bg-[#0F5B3C] text-white font-bold'
...
export default function AdminLayout() {
  ...
  return (
    <div className="flex min-h-screen bg-[#F2F5F3] dark:bg-[#0B1310]">
      <ScrollToTop />
      {/* Mobile topbar */}
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-30 lg:hidden w-14 h-14 bg-[#0F5B3C] text-white rounded-full shadow-xl flex items-center justify-center hover:bg-emerald-700 active:scale-90 transition-all"
      >
        <Search size={22} />
      </button>
